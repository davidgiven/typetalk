declare namespace preact {
	...
	interface PreactHTMLAttributes {
		key?:string;
		ref?:((e: Element)=>void);
		dangerouslySetInnerHTML?:HTMLElement;
	}
	...
	interface LifecycleFunctions<PropsType, StateType> {
	...
	abstract class Component<PropsType, StateType> implements LifecycleFunctions<PropsType, StateType> {
